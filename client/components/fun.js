...
//       />
//       <svg viewBox="0 0 175 281" version="1.1">
//       <rect className="fill-1" x="0" y="22" width="55" height="204" />
//     </svg>,
//     </svg>,
...
const U6 = {
  bounds: [170, 281],
  forms: [
      <svg viewBox="0 0 170 281" version="1.1">
          <rect className="fill-1" y="22" width="55" height="204"/>
      </svg>,
      <svg viewBox="0 0 170 281" version="1.1">
          <path className="fill-2" d="M0,226c0,30.4,24.6,85,85,85s85-24.6,85-85H0z"/>
      </svg>,
      <svg viewBox="0 0 170 281" version="1.1">
      <rect className="fill-1" x="115" y="22" width="55" height="204"/>
      </svg>,
  ],
};
...
const S7 = {
  ...
  forms: [
    <svg viewBox="0 0 167 281" version="1.1">
      <path className = 'fill-1' width = "35" height="204"
...
const H8 = {
  ...
  forms: [
    ...
    <svg viewBox="0 0 175 281" version="1.1">
    <rect className="fill-1" x="55" y="80" width="65" height="55" />
    </svg>,
     <svg viewBox="0 0 175 281" version="1.1">
     <rect className="fill-1" x="120" y="22" width="55" height="204" />
   </svg>
  ]
}
